...
export default class FullScreenContainer extends React.Component {
  ...
  componentWillReceiveProps(nextProps) {
    if (nextProps.mediaList.length <= this.state.currentIndex) {
      this.openPage(nextProps.mediaList.length-1, false);
    }
  }
  ...
  openPage(index, animated) {
    ...
    //this.scrollView.snapToItem(index, false);
              ...
              directionalLockEnabled={true}>
                  ...
                  <View style={styles.listInnerContainer}>
                    <Carousel
                      ...
                      containerCustomStyle={styles.flex}
                      onSnapToItem={this._onPageSelected.bind(this)}
                    />
                  </View>
            </ScrollView>
    );
